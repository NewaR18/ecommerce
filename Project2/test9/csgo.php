...
'$_POST[EMonth]',
 ...
 '$dst_db3'
    ...
    header('location:certificate.php?email='.$_POST['email']);
}
    ?>
    <img class="bg" src="1mid1.jpg" alt="photo">
    <img class="bg2" src="1mid3.jpg" alt="photo">
    ...
    <section>
        <ul id="amate">
            ...
            <li class="a2">
                <br>
                <h><b>Registration form for Counter-Strike Global Offensive (CS:GO) Players:-</b></h></br></br><hr>
                    ...
                    <div class="namez2">
                        ...
                        <div class="fn fn2">
                            ...
                            <select name= "rank" class="cs" id="name2">
                                ...
                                <option value="se">Silver Elite</option>
                                <option value="sem">Silver Elite Master</option>
                                <option value="g1"> Gold Nova I</option>
                                <option value="g2">Gold Nova II</option>
                                <option value="g3">Gold Nova III</option>
                                <option value="gnm">Gold Nova Master</option>
                                <option value="mg1">Master Guardian I</option>
                                <option value="mg2">Master Guardian II</option>
                                <option value="mge">Master Guardian Elite</option>
                                ...
                                <option value="smfc">Supreme Master First Class</option>
                                <option value="ge">Global Elite</option>
                            </select></br></br>
                            </div>    
                        </div>
                    <br/><hr><br/>
