...
'$_POST[EMonth]',
 ...
 '$dst_db3'
    ...
    header('location:certificate2.php?email='.$_POST['email']);
}
    ?>
    <img class="bg" src="2mid2.jpg" alt="photo">
    <img class="bg2" src="2mid3.jpg" alt="photo">
    ...
    <section>
        <ul id="amate">
            ...
            <li class="a2">
                <br>
                <h><b>Registration form for Call of Duty (COD) Players:-</b></h></br></br><hr>
                    ...
                    <div class="namez2">
                        ...
                        <div class="fn fn2">
                            ...
                            <select name= "rank" class="cs" id="name2">
                                <option value="rook1">Rookie I</option>
                                <option value="rook2">Rookie II</option>
                                <option value="rook3">Rookie III</option>
                                <option value="rook4">Rookie IV</option>
                                <option value="rook5">Rookie V</option>
                                <option value="vet1">Veteran I</option>
                                <option value="vet2">Veteran II</option>
                                <option value="vet3">Veteran III</option>
                                <option value="vet4">Veteran IV</option>
                                <option value="vet5">Veteran V</option>
                                <option value="eli1">Elite I</option>
                                <option value="eli2">Elite II</option>
                                <option value="eli3">Elite III</option>
                                <option value="eli4">Elite IV</option>
                                <option value="eli5">Elite V</option>
                                ...
                                <option value="mas1">Master I</option>
                                <option value="mas2">Master II</option>
                                <option value="mas3">Master III</option>
                                <option value="mas4">Master IV</option>
                                <option value="mas5">Master V</option>
